...
#ifndef MRH_PSBReset_h
#define MRH_PSBReset_h
...
public:
    ...
    /**
     *  Perform a callback with a recieved platform service event.
     *
     *  \param p_Event The recieved platform service event.
